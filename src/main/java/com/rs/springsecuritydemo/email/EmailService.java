...
public class EmailService implements EmailSender{
    ...
    //TODO: move to queue implementation.
    @Override
    @Async
    public void send(String to, String email) {
        try {
            ...
            helper.setFrom("test@registration.test");
            mailSender.send(mimeMessage);

        }catch (MessagingException e){
            LOGGER.error("Fail to send e-mail", e);
            throw new IllegalStateException("Failed to send e-mail.");
        }
    }

    //TODO: Create a more elegant way to generate the e-mail body.
